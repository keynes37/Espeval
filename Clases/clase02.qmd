...
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) +
  ...
  annotate("text", label = expression(Delta*"CT"=="Costo Marginal"), x = 2 - 0.5, y = (tc_1 + tc_2)/2, color = met_slate, family = "Fira Sans", size = 4) +
...
::: {.column width="40%"}
Los [Costos fijos]{.alert} no varian con la producción
</br>
Los [Costos variables]{.oranger} se afectan cuando la producción varía
