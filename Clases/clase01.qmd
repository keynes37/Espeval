...
::: fragment
$$\epsilon^{d}=\dfrac{\text{%} \triangle Q_{d}}{\text{%} \triangle P} = \dfrac{\dfrac{\triangle Q}{Q}}{\dfrac{\triangle P}{P}}$$
:::
...
::: fragment
$$Var \; =\frac{( 14700-13000 )}{13000}*100=13 \text{%}$$
:::
...
::: fragment
$$Var\;=\frac{\left ( 15-20 \right )}{20}*100= -25\text{%}$$
:::

::: fragment
La elasticidad viene a ser: $e_d=\dfrac{-25\text{%}}{13\text{%}}=-1.92$, que significa que el cambio ha sido elástico.
:::
