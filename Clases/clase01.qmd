...
`r fa("chess-bishop", fill="blue")` Jueces de tribunales de apelación.
:::
...
1. Desacuerdo
1. Conduce a un *ciclo de votación*: una mayoría se opone a cada resultado
1. Cada [opción]{.alert} perderá frente a otra alternativa
...
::: {.column width="50%"}
  - Enfrentamientos:
    ...
    - A vs C: A gana (65% vs 35%)
    - B vs C: B gana (75% vs 25%)
  - **Resultado**: A es el ganador de Condorcet porque vence a B y a C.
...
::: {.column width="50%"}
  - **Ronda 2**:
    - Los votos de C se redistribuyen: B gana con el 60% de los votos.
  - **Resultado**: B es el ganador tras la eliminación de C.
...
- **Ejemplo**:
  ...
  - Primera vuelta:
    ...
    - C: 25%
  - **Segunda vuelta**:
    - A vs B: A gana con 55% frente a B (45%).
...
::: fragment
Imagine que una municipio debe decidir entre cuatro proyectos de [infraestructura pública]{.blut}, y las partes interesadas (ciudadanos, funcionarios, etc.) han votado según sus [preferencias]{.alert}. 
:::

::: fragment
Los proyectos son:
Proyecto A: [Construcción de un parque comunitario]{.alert}.
Proyecto B: [Expansión de la red de transporte público]{.oranger}.
Proyecto C: [Renovación de la infraestructura escolar]{.slater}.
...
- Optimizamos de acuerdo a decisiones
      ...
      - Pero debo vivir en un piso mas pequeño
:::
...
1. [Efecto Sustitución]{.alert}: Cambio en el consumo debido a un cambio relativo en los precios
...
- El [tamaño]{.under} del efecto depende en donde se gasta usted su ingreso (Casa/Carro/Apto)

- Si solo consume bienes como (lapicero/leche/souvenirs) no habrá mucha diferencia.
:::
...
::: {.column width="30%"}
Afecta y genera un nuevo consumo de $(X)$ y tiene mas "poder"
:::
